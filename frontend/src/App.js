...
function App() {
  ...
  const handleVoiceCommand = useCallback((commandObj) => {
    ...
    // Update command log
    setVoiceCommands((prevCommands) => [commandWithTimestamp, ...prevCommands]);
  ...
  const handleSearchCommand = async (commandObj) => {
    if (!commandObj.query) return;

    setIsLoading(true);
    try {
      // Search for places using geocoding service
      const results = await geocodingService.smartSearch(commandObj.query);
              ...
              {showHelp && (
                <div className="collapsible-panel expanded">
                  ...
                  <div className="panel-content">
                    ...
                    <ul>
                      <li>
                        <strong>Search:</strong> "Find restaurants near me"
                      </li>
                      <li>
                        <strong>Navigate:</strong> "Take me to Central Park"
                      </li>
                      <li>
                        <strong>Layers:</strong> "Show traffic layer"
                      </li>
                      <li>
                        <strong>Zoom:</strong> "Zoom in", "Zoom out", "Set zoom level 15"
                      </li>
                      <li>
                        <strong>Reset:</strong> "Reset map"
                      </li>
                    </ul>
                  </div>
                </div>
